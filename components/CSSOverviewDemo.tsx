  ...
  return (
    <div className="max-w-4xl w-full mx-auto bg-slate-50 p-4 sm:p-6 rounded-xl shadow-2xl border border-slate-200">
      ...
      <div className="space-y-4">
        ...
        {/* Expected Findings Card */}
        <div className="text-slate-700 bg-white p-4 rounded-lg shadow-md border">
          ...
          <div className="text-green-700 flex items-center gap-2 mt-3 text-xs sm:text-sm">
